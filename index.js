...
const DEFAULTS = { enabled: true, styleCommands: true, showLockscreen: false, panelOpen: false, batchMode: false, autoDetectNpcs: true, manualHybridPrivateTexts: true, contactsInjectEveryN: 1, questsInjectEveryN: 1, autoPrivatePollEveryN: 0, trackLocations: true, autoRegisterPlaces: true, mapInjectEveryN: 3, showLocationTrails: true, nova: { profileName: '', defaultTier: 'read', maxToolCalls: 24, turnTimeoutMs: 300000, pluginBaseUrl: '/api/plugins/nova-agent-bridge', rememberApprovalsSession: false, activeSkill: 'freeform' } };
