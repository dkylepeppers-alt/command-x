...
> path, and console string is quoted verbatim from the v0.13.0 source.
>
...
- [ ] **Codex CLI:** `manifest.json` reports `"version": "0.13.0"`:
...
- [ ] **User/browser:** Hard-refresh the ST page (Ctrl+Shift+R) and open the
  ...
  **`[command-x] v0.13.0 Loaded OK`** with no red errors above or below it.
